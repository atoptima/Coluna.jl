...
register!(unit_tests, "parser", parser_strip_indentation; f = true)
...
register!(unit_tests, "parser", parser_strip_line; f = true)
...
register!(unit_tests, "parser", parser_get_vars_list; f = true)
...
register!(unit_tests, "parser", parser_read_expression; f = true)
...
register!(unit_tests, "parser", parser_read_constraint; f = true)
...
register!(unit_tests, "parser", parser_read_bounds; f = true)
