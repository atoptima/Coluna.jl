...
function variable_getters_and_setters_tests()
    ...
    @test ClF.getperenecost(v) == ClF.getcurcost(v) == ClF.getcost(ClF.getcurdata(v)) == ClF.getcost(ClF.getrecordeddata(v)) == 13.0
    @test ClF.getperenelb(v) == ClF.getcurlb(v) == ClF.getlb(ClF.getcurdata(v)) == ClF.getlb(ClF.getrecordeddata(v)) == -10.0
    @test ClF.getpereneub(v) == ClF.getcurub(v) == ClF.getub(ClF.getcurdata(v)) == ClF.getub(ClF.getrecordeddata(v)) == 100.0

    ClF.setcurcost!(v, -134.0)
    ClF.setcurlb!(v, -2001.9)
    ClF.setcurub!(v, 2387.0)

    @test ClF.getcurcost(v) == ClF.getcost(ClF.getcurdata(v)) == -134.0
    @test ClF.getcurlb(v) == ClF.getlb(ClF.getcurdata(v)) == -2001.9
    @test ClF.getcurub(v) == ClF.getub(ClF.getcurdata(v)) == 2387.0
    @test ClF.getperenecost(v) == ClF.getcost(ClF.getrecordeddata(v)) == 13.0
    @test ClF.getperenelb(v) == ClF.getlb(ClF.getrecordeddata(v)) == -10.0
    @test ClF.getpereneub(v) == ClF.getub(ClF.getrecordeddata(v)) == 100.0
