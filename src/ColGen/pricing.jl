...
"""
@mustimplement "ColGenIteration" compute_sp_init_db(ctx, sp) = nothing

"""
Returns an initial primal bound for a pricing subproblem.
Default value should be +/- infinite depending on the optimization sense.
"""
@mustimplement "ColGenIteration" compute_sp_init_pb(ctx, sp) = nothing
...
pseudo dual bound.
"""
@mustimplement "ColGenPricing" get_primal_bound(pricing_res) = nothing
