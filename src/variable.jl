...
function Variable(m::AbstractModel, n::String, c::Float64, lb::Float64, 
        ub::Float64, t::VarType, d::VarDuty, s::VarSense)
    uid = getnewuid(m.var_counter)
    return Variable(uid, n, c, lb, ub, t, d, s, MOI.VariableIndex(-1), nothing, nothing)
end

function Variable(m::AbstractModel,  n::String)
    return Variable(m, n, 0.0, -Inf, Inf, Continuous, OriginalVar, Free)
end
