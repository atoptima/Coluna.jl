...
several primal heuristics to more efficiently find feasible solutions, and a "node finalizer"
algorithm to try to conquer the node if the gap is still unclosed.
"""
