...
Coluna.jl solves Mixed Integer Programs (MIP) by application reformulation
...
3. the reformulation is automatically generated by the code,
...
4. a default column generation procedure is implemented that relies
